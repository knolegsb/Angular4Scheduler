...
export class UserCardComponent implements OnInit {
    ...
    @ViewChild('childModel') public childModal: ModalDirective;
    @Input() user: IUser;
    ...
    updateUser() {
        ...
        this.dataService.updateUser(this.editedUser)
            .subscribe(() => {
                ...
                this.onEdit = !this.onEdit;
                this.notificationService.printSuccessMessage(this.user.name + ' has been upudated');
                // this.slimLoader.complete();                
            }, error => {
    ...
    openRemoveModal() {
        this.notificationService.openConfirmationDialog('Are you sure you want to remove ' + this.user.name + '?', () => {
            // this.slimLoader.start();
